...
- [Agent configuration](04-agent-configuration.qmd)
- [Agent interactions](05-agent-interactions.qmd)
- [Multi-agent workflows](06-multi-agent-workflows.qmd)
...
### `hf_sequence_classifier` (Hugging Face Sequence Classifier)
...
## Naive Bayes vs HF Sequence Classifier
